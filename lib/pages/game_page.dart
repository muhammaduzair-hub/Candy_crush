...
class _GamePageState extends State<GamePage>
  ...
  void initState() {
    ...
    // if(ResumeGame.level == widget.level){
    //   popupresume();
    // }
    // else if(ResumeGame.level == "0"){
    //   ResumeGame.grid = gameBloc.gameController.grid;
    // }
    ...
    return StreamBuilder<bool>(
      ...
      builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
        if (snapshot.data != null && snapshot.hasData) {
          ...
          //print('lenghtttttttttttttttttttttttttttttttt=>${ResumeGame.grid.height},${ResumeGame.grid.width}');
