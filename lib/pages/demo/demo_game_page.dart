...
import 'package:flutter_application2/animations/animation_chain.dart';
import 'package:flutter_application2/animations/animation_combo_collapse.dart';
import 'package:flutter_application2/animations/animation_combo_three.dart';
import 'package:flutter_application2/animations/animation_swap_tiles.dart';
import 'package:flutter_application2/bloc/bloc_provider.dart';
import 'package:flutter_application2/bloc/game_bloc.dart';
import 'package:flutter_application2/game_widgets/board.dart';
import 'package:flutter_application2/game_widgets/game_moves_left_panel.dart';
import 'package:flutter_application2/game_widgets/game_over_splash.dart';
import 'package:flutter_application2/game_widgets/game_score_panel.dart';
import 'package:flutter_application2/game_widgets/game_splash.dart';
import 'package:flutter_application2/game_widgets/mydropdown.dart';
import 'package:flutter_application2/game_widgets/objective_panel.dart';
import 'package:flutter_application2/game_widgets/shadowed_text.dart';
import 'package:flutter_application2/helpers/animations_resolver.dart';
import 'package:flutter_application2/helpers/array_2d.dart';
import 'package:flutter_application2/helpers/audio.dart';
import 'package:flutter_application2/model/animation_sequence.dart';
import 'package:flutter_application2/model/combo.dart';
import 'package:flutter_application2/model/level.dart';
import 'package:flutter_application2/model/row_col.dart';
import 'package:flutter_application2/model/tile.dart';
import 'package:flutter/material.dart';

class DemoGamePage extends StatefulWidget {
  static Route<dynamic> route(Level level) {
    return MaterialPageRoute(
        builder: (BuildContext context) => DemoGamePage(level: level));
  }
  ...
  @override
  _DemoGamePageState createState() => _DemoGamePageState();
}

class _DemoGamePageState extends State<DemoGamePage>
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          Navigator.of(context).pop();
          DemoPageThings.tiles.clear();
          DemoPageThings.demo = false;
          DemoPageThings.index = 0;
        },
      ),
      body: Container(
  ...
  Widget _buildScore(Orientation orientation){
        ...
        if (snapshot.data != null && snapshot.hasData) {
          ...
          for (int row = 0; row < widget.level.numberOfRows; row++) {
            for (int col = 0; col < widget.level.numberOfCols; col++) {
              ...
              for(int i = 0; i<DemoPageThings.tiles.length; i++){
                if(tile.type == DemoPageThings.tiles[i]){
                  demotest = true;
                  break;
                }
              }

              if(tile.type == DemoPageThings.tiles[DemoPageThings.index==0? DemoPageThings.tiles.length-1: DemoPageThings.index-1])
                print("tile of row$row and column $col is ${tile.type}");
              if (tile.type != TileType.empty &&
                  tile.type != TileType.forbidden &&
                  tile.visible && demotest) {
                //
